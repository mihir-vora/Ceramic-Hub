...
$query=mysqli_query($db,"SELECT MAX(id) AS pid FROM products WHERE `cmp_id`='$cmp_id' ");
...
$cmp_id = $_SESSION['c_id'];
$sql=mysqli_query($db,"INSERT INTO products(category,productName,productCompany,productPrice,productDescription,shippingCharge,productAvailability,productImage1,productImage2,productImage3,productPriceBeforeDiscount, cmp_id) VALUES('$category','$productname','$productcompany','$productprice','$productdescription','$productscharge','$productavailability','$productimage1','$productimage2','$productimage3','$productpricebd', '$cmp_id')");
