    ...
    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
		<form method="post" action="company_register.php" >
			...
			<div class="form-group">
				...
				<input type="text" name="companyname" id="display_name" class="form-control input-lg" placeholder="Display Name" tabindex="3">
			</div>
			<div class="form-group">
				<label for="exampleFormControlTextarea1">Business Email</label>
				<input type="email" name="businessemail" id="email" class="form-control input-lg" placeholder="Email Address" tabindex="4">
			</div>
			 <div class="form-group">
			    <label for="exampleFormControlTextarea1">Company Address</label>
			    <textarea class="form-control" 
			    name="companyaddress" id=" exampleFormControlTextarea1" rows="3"></textarea>
 			</div>
			<div class="row">
				<div class="col-xs-12 col-sm-6 col-md-6">
					<div class="form-group">
			...
			<div class="row">
				<div class="col-xs-12 col-md-6"><input type="submit" name="com_reg" value="Register Button" class="btn btn-primary btn-block btn-lg" tabindex="7"></div>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-primary" data-dismiss="modal" required="">I Agree</button>
			</div>
		</div><!-- /.modal-content -->
	</div><!-- /.modal-dialog -->
</div><!-- /.modal -->
