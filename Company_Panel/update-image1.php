...
//unlink($dir.'/'.$pimage);
	...
	move_uploaded_file($_FILES["productimage1"]["tmp_name"],"/$pid/".$_FILES["productimage1"]["name"]);
	$sql=mysqli_query($db,"UPDATE  products set productImage1='$productimage1' where id='$pid' ");
...
$query=mysqli_query($db,"SELECT productName,productImage1 from products where id='$pid'");
$cnt=1;
