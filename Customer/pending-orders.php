...
header('location:login.php');
	...
	if (isset($_GET['id'])) {
		...
		mysqli_query($db,"DELETE FROM orders  WHERE userId='".$_SESSION['u_id']."' and paymentMethod is null and id='".$_GET['id']."' ");
		;
				...
				<tr>
					...
					<td class="cart-image">
						<a class="entry-thumbnail" href="detail.html">
						    <img src="/Ceramic-Hub/Company_Panel/productimages/<?php echo $row['proid'];?>/<?php echo $row['pimg1'];?>" alt="" width="84" height="146">
						</a>
					</td>
