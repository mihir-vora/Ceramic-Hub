...
mysqli_query($db,"INSERT INTO orders(userId,productId,quantity) VALUES('".$_SESSION['u_id']."','$qty','$val34')");
...
// code for billing address updation
	if(isset($_POST['update']))
	{
		...
		$query=mysqli_query($db,"UPDATE users SET billingAddress='$baddress',billingState='$bstate',billingCity='$bcity',billingPincode='$bpincode' WHERE id='".$_SESSION['u_id']."'");
		if($query)
		{
...
// code for Shipping address updation
	if(isset($_POST['shipupdate']))
	{
		...
		$query=mysqli_query($db,"UPDATE users SET shippingAddress='$saddress',shippingState='$sstate',shippingCity='$scity',shippingPincode='$spincode' WHERE id='".$_SESSION['u_id']."'");
		if($query)
		{
				...
				<tr>
					...
					<td class="cart-image">
						<a class="entry-thumbnail" href="detail.html">
						    <img src="/Ceramic-Hub/Company_Panel/productimages/<?php echo $row['id'];?>/<?php echo $row['productImage1'];?>" alt="" width="114" height="146">
						</a>
					</td>
...
<?php
$query=mysqli_query($db,"SELECT * FROM users WHERE id='".$_SESSION['u_id']."'");
while($row=mysqli_fetch_array($query))
{
?>
